# Contributing to StrixPDF

First off, thank you for considering contributing to **StrixPDF**! Your help makes this project better for everyone.
...
Before we can accept your contributions, you must sign our Contributor License Agreement (CLA). This is required because StrixPDF uses a dual licensing model:
...
If you are contributing on behalf of your employer, your organization needs to sign our [Corporate Contributor License Agreement (CCLA)](CCLA.md). Please open an issue at [github.com/ricardoborges/StrixPDF](https://github.com/ricardoborges/StrixPDF/issues) to arrange corporate CLA signing.
...
1.  **Fork the Repository**
    ...
    ```bash
    git clone https://github.com/ricardoborges/StrixPDF.git
    cd StrixPDF
    npm install
    ```
...
**Issues:** [github.com/ricardoborges/StrixPDF/issues](https://github.com/ricardoborges/StrixPDF/issues)
...
Thank you for helping make **StrixPDF** a better library for everyone!
