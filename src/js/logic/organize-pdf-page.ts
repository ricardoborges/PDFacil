...
async function renderThumbnails() {
    ...
    for (let i = 1; i <= organizeState.totalPages; i++) {
        ...
        imgContainer.className = 'w-full h-36 bg-gray-50 rounded-lg flex items-center justify-center overflow-hidden border-2 border-gray-300';
        ...
        pageLabel.className = 'page-number absolute top-1 left-1 bg-gray-900 bg-opacity-70 text-white text-xs rounded-full px-2 py-1';
