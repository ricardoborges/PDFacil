...
function updateAttachmentList() {
    ...
    pageState.attachments.forEach(function (file) {
        ...
        div.className = 'flex justify-between items-center p-2 bg-white rounded-md text-gray-900';
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (attachmentInput && attachmentDropZone) {
        ...
        attachmentDropZone.addEventListener('dragover', function (e) {
            e.preventDefault();
            attachmentDropZone.classList.add('bg-gray-100');
        });

        attachmentDropZone.addEventListener('dragleave', function (e) {
            e.preventDefault();
            attachmentDropZone.classList.remove('bg-gray-100');
        });
